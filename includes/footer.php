...
<footer class="bg-dark fixed-bottom text-light text-center footer">
    <div class="container">
        <span class="text-muted">&copy; <?php  echo date('Y ') ;  ?>Catalogo creado por <a target="_blank"  href="https://www.linkedin.com/in/daniel-videla-fullstackdeveloper/"> <i class="bi bi-linkedin"> </i> Daniel Videla</a> </span>
    </div>
